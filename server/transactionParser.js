...
const CATEGORY_RULES = [
  { keywords: ['restaurant', 'restoran', 'cafetería', 'cafe', 'starbucks', 'hamburguesa', 'pizza', 'sushi', 'comida', 'almacen', 'supermercado', 'jumbo', 'lider', 'tottus', 'santa isabel', 'unimarc', 'aczent', 'te tin ka', 'mcdonald', 'kfc', 'delivery', 'pedidos ya', 'rapp', 'uber eats', 'docal', 'panader'], category: 'Alimentos' },
  { keywords: ['copec', 'shell', 'petrobras', 'terpel', 'parra', 'bencinera', 'servicentro', 'metro de santiago', 'transporte', 'uber', 'cabify', 'did', 'taxi', 'bus', 'micro', 'colectivo', 'autopista', 'tag', 'peaje', 'pasaje'], category: 'Transporte' },
  { keywords: ['luz', 'chilquinta', 'enel', 'cge', 'aguas andinas', 'essbio', 'aguas nuevas', 'nuevosur', 'agua potable', 'gasco', 'lipigas', 'abastible', 'metrogas', 'gas', 'telefono', 'movistar', 'entel', 'claro', 'wom', 'vtr', 'internet', 'plan telef', 'agua'], category: 'Servicios' },
  { keywords: ['netflix', 'spotify', 'disney', 'hbo', 'max', 'prime video', 'star+', 'paramount', 'crunchyroll', 'playstation', 'xbox', 'nintendo', 'steam', 'twitch', 'youtube premium', 'youtube music', 'apple music', 'apple tv', 'icloud', 'apple.com/bill', 'microsoft 365', 'office 365', 'adobe', 'notion', 'figma', 'dropbox', 'google one', 'google storage', 'icloud+', 'chatgpt', 'openai', 'patreon', 'onlyfans', 'amazon prime', 'paramount+', 'apple one', 'microsoft', 'zoom', 'github', 'notion ai', 'perplexity', 'cursor', 'membership', 'mensualidad', 'suscripc', 'subscription', 'recurring', 'plan mensual', 'plan anual', 'premium'], category: 'Suscripción' },
  { keywords: ['cine', 'cinemark', 'cinepolis', 'hoyts', 'juegos', 'game', 'juego'], category: 'Entretención' },
  { keywords: ['farmacia', 'farmacias', 'salud', 'clínica', 'clinica', 'hospital', 'médico', 'medico', 'doctor', 'dentista', 'óptica', 'optica', 'laboratorio', 'isapre', 'fonasa', 'bono', 'consulta', 'cruz verde', 'salco', 'ahumada'], category: 'Salud' },
  { keywords: ['sodimac', 'easy', 'construcción', 'construccion', 'ferreteria', 'ferretería', 'hogar', 'mueble', 'deco', 'paris', 'falabella', 'ripley', 'la polar', 'abcdin', 'hites', 'corona', 'tricot'], category: 'Compras Generales' },
