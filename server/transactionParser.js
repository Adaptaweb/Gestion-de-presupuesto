...
const CATEGORY_RULES = [
  ...
  { keywords: ['luz', 'chilquinta', 'enel', 'cge', 'aguas andinas', 'essbio', 'aguas nuevas', 'nuevosur', 'agua potable', 'gasco', 'lipigas', 'abastible', 'metrogas', 'gas', 'telefono', 'movistar', 'entel', 'claro', 'wom', 'vtr', 'internet', 'plan telef', 'agua', 'apple.com/bill', 'apple music', 'icloud'], category: 'Servicios' },
  { keywords: ['netflix', 'spotify', 'disney', 'hbo', 'max', 'prime video', 'star+', 'paramount', 'crunchyroll', 'cine', 'cinemark', 'cinepolis', 'hoyts', 'juegos', 'game', 'playstation', 'xbox', 'nintendo', 'steam', 'twitch', 'youtube'], category: 'Entretención' },
